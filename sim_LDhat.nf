...
process isolateGenome{
    ...
    input:
        file genomes_forIsolate
        val sOut4
        val mOut4
        val rOut4

    output:
        file "firstGenome.fa" into genome_forIndex, genomes_forLofreq
...
process artIllumina{
    ...
    output:
        file "art_fastSimBac.fq" into artOut// only file we are interested in

    script:
        """
        art_illumina --seqSys HSXt --rndSeed "${sOut5}" --noALN \
